...
-- Records of config
-- ----------------------------
INSERT INTO `config` VALUES (1, 7, 1, 'Hjh图床', 'Hjh图像托管，是一家免费开源的图像托管，即时分享你的美好瞬间。', 'https://gaip-api.wepromo.cn/storage/images/standard_bg.jpg', '1', '<p style=\"color:#7c7c88;\">版权所有&copy;<a href=\"https://www.wepromo.cn/\" target=\"_blank\" title=\"HjhAI\">Hjh图像托管</a><span>&nbsp;2019- 2023 </span> </p>', '也许...|这将是最好用的图床|为了更好的用户体验，建议您注册本站继续免费使用Hjh图床。本站不得上传任何形式的非法图片，一旦发现，永久删除并禁封账户。情节严重者将相关资料交于相关部门处理。', 'var _hmt = _hmt || [];\n(function() {\n  var hm = document.createElement(\"script\");\n  hm.src = \"https://hm.baidu.com/hm.js?16c326e608c984c9bae6a63eda861888\";\n  var s = document.getElementsByTagName(\"script\")[0]; \n  s.parentNode.insertBefore(hm, s);\n})();\n\n', 'http://api.hellohao.cn', '', 'https://gaip-api.wepromo.cn/storage/images/standard_bg.jpg', 1, 'Hjh图像托管，是一家免费开源的图像托管，即时分享你的美好瞬间。', 'hellohao图床,图床,图片上传,开源图床,hellohao,图像托管，图片分享', 'https://hellohao.nos-eastchina1.126.net/BlogImg/favicon.ico', 2, '这将是你用过最优秀的图像托管程序', NULL, '<img width=\"300px\" src=\"https://gaip-api.wepromo.cn/storage/images/standard_bg.jpg\">\n            <br />\n            <br />\n            <p>也许,这将是你用到最优秀的图像托管程序</p>\n            <p>本程序为Hellohao图象托管程序</p>\n            <br/>\n            <p style=\"color: #656565;\">作者：hellohao独立开发</p>\n            <p style=\"color: #656565;\">www.hellohao.cn</p>');
